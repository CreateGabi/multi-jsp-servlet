...
<div id = "total">
	...
	<table border="1" class="table table-hover">
		<tr class="table-info">
			<td rowspan="5"  class="table-info">
				<img alt="상품이미지" src="img/<%= dto2.getImg() %>" height="400" width="500">
			</td>
			<td>
				<span class="alert alert-danger">상품아이디:
				<%= dto2.getId() %>
				</span>
			</td>
		</tr>
		...
		<tr  class="table-info">
			...
			<td>
			<span class="alert alert-success">상품설명:
			<%= dto2.getContent() %>
			</span>
			</td>
		</tr>
		<tr  class="table-info">
			<td>
			<span class="alert alert-success">상품가격:
			<%= dto2.getPrice() %>원
			</span>
			</td>
		...
		<tr  class="table-info">
			<td>
			<span class="alert alert-success">상품회사:
			<%= dto2.getCompany() %>
			 </span>
			</td>
		</tr>
